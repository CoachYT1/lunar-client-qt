...
QStringList Utils::getClassPath(const QStringList& files, const QString& version, const QString& modLoader) {
    ...
    for (const QString& filename : files) {
        ...
        if (filename.startsWith(QString("OptiFine_v")) || filename.startsWith(QString("Forge_v")) || filename.startsWith(QString("Phosphor_v")) || filename.startsWith(QString("Sodium_v")) || filename.startsWith(QString("Iris_v")) || filename.startsWith(QString("Indium_v")) || filename.contains(QString("NEU"), Qt::CaseInsensitive) || filename.contains(QString("LunatriusCore"), Qt::CaseInsensitive) || filename.contains(QString("SBA"), Qt::CaseInsensitive) || filename.contains(QString("DSM"), Qt::CaseInsensitive) || filename.contains(QString("Schematica"), Qt::CaseInsensitive) || filename.contains(QString("Sodium"), Qt::CaseInsensitive) || filename.contains(QString("Indium"), Qt::CaseInsensitive) || filename.contains(QString("Iris"), Qt::CaseInsensitive))
            continue;
